...
```
module "CanaryWorker" {
    source = "git@github.com:starframe-systems/tf-stencils.git//lambda?ref=v0.1.12"
...
module "CanaryScheduler" {
  source = "git@github.com:starframe-systems/tf-stencils.git//event_bridge_scheduler?ref=v0.1.12"
